...
class SignInViewController: UIViewController {
    ...
    lazy var signInWithAppleIDButton = {
            ...
            let title = "SIGN_IN_WITH_APPLEID_BUTTON".localized()
            let font = UIFont(name: "SFProDisplay-Semibold", size: 14) ?? .systemFont(ofSize: 14)
            let color = UIColor(named: "111827-FFFFFF") ?? .black
    ...
    lazy var signInWithGoogleButton = {
        ...
        let title = "SIGN_IN_WITH_GOOGLE_BUTTON".localized()
        let font = UIFont(name: "SFProDisplay-Semibold", size: 14) ?? .systemFont(ofSize: 14)
        let color = UIColor(named: "111827-FFFFFF") ?? .black
...
extension SignInViewController: UITextFieldDelegate {
    ...
    @objc private func localizeLanguage() {
        ...
        questionLabel.text = "QUESTION_LABEL_SIGN_IN".localized()
